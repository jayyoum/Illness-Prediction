#!/usr/bin/env python3
"""
Stepwise Selection with Lagged Environmental Variables (Optimized)
Pre-filters to key environmental variables to make search practical
"""
    ...
    while True:
        ...
        if scores_with_candidates:
            ...
            if best_new_score > current_score:
                ...
                changed = True
                if verbose:
                    print(f"  ✅ Added: {best_candidate} | Adj R² = {current_score:.4f}")
        ...
        if len(selected) > 1:
            ...
            if scores_with_candidates:
                ...
                if best_new_score > current_score:
                    ...
                    changed = True
                    if verbose:
                        print(f"  ❌ Removed: {worst_candidate} | Adj R² = {current_score:.4f}")
...
# === MAIN LOOP ===
print("="*80)
print("STEPWISE SELECTION - OPTIMIZED")
print("="*80)
