#!/usr/bin/env python3
"""
Forward Selection with Lagged Environmental Variables
Imitates original forward_selection.py but uses data with 1-14 day lags
"""
...
# === MAIN LOOP ===
print("="*80)
print("FORWARD SELECTION - LAGGED ENVIRONMENTAL VARIABLES")
print("="*80)
