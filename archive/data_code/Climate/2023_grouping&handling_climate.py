...
class KMAClimateAnalyzer:
    ...
    def export_results(self, df: pd.DataFrame, analysis_results: Dict[str, pd.DataFrame], 
        ...
        try:
            ...
            df.to_csv(f'{output_dir}/2023_processed_climate_data.csv', encoding='utf-8', index=False)
...
def main():
    # Set the file path
    file_path = os.path.join(os.path.expanduser("~"), "Desktop", "Raw Data", "Climate Data 2", "2023.csv")
