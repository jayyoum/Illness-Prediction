...
def run_lagged_correlation_by_sex(
    env_data_template: str,
    sex_illness_folder: str,
    output_base_dir: str,
    year: int,
    max_lag: int = 7
):
    ...
    for sex in ["Male", "Female"]:
        print(f"\n🧬 Processing Sex: {sex}")
        illness_path = os.path.join(sex_illness_folder, f"relevant_illness_{sex}_{year}.csv")
        ...
        for lag in range(0, max_lag + 1):
            ...
            lagged_df['ParsedDateTime'] += pd.Timedelta(days=lag)
            ...
            # Save to subfolder inside output folder
            lag_output_dir = os.path.join(output_base_dir, sex, f"lag_{lag}")
...
if __name__ == "__main__":
    run_lagged_correlation_by_sex(
        env_data_template="/Users/jay/Desktop/Illness Prediction/Processed Data/Merged Data/{year}_merged_with_lag.csv",
        sex_illness_folder="/Users/jay/Desktop/Illness Prediction/Processed Data/Illness Data/relevant illnesses sex",
        output_base_dir="/Users/jay/Desktop/Illness Prediction/Processed Data/Correlation Results/sex_filtered_correlation_2019",
        year=2019,
        max_lag=7
    )
