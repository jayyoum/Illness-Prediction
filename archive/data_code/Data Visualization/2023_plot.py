...
# Load the CSV
file_path = '/Users/jay/Desktop/Processed Data/Climate Data/2023.csv'
...
output_base_dir = '/Users/jay/Desktop/Region_Plots_All_Variables_2023'
...
for region in region_codes:
    ...
    for var in variable_columns:
        ...
        plt.title(f'{var} Over Time - Region {region} (2023)')
        plt.xlabel('DateTime')
        plt.ylabel(var)
        plt.grid(True)
        plt.tight_layout()
