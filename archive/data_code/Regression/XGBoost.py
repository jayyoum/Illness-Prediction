...
output_base_dir = "/Users/jay/Desktop/Illness Prediction/Processed Data/Regression Results/XGB on Intersected/BE_lag3"
...
for filename in os.listdir(merged_data_dir):
    ...
    output_path = os.path.join(output_dir, f"XGB_{lag_label}.csv")
    pd.DataFrame(results).to_csv(output_path, index=False)
    print(f"✅ XGB complete for {illness_name} — saved to {output_path}")
