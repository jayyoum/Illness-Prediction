...
# === USER CONFIG ===
year = 2019
illness_name = "Gastritis, unspecified"
lag_days = 1  # ← Adjust lag here

# === FILE PATHS ===
illness_path = f"/Users/jay/Desktop/Illness Prediction/Processed Data/Illness Data/final_illnesses/relevant_illness_{year}.csv"
env_path = f"/Users/jay/Desktop/Illness Prediction/Processed Data/Merged Data/{year}_merged_with_lag.csv"
output_path = f"/Users/jay/Desktop/Illness Prediction/Processed Data/Regression Results/MLR_Coefficients_{illness_name}_lag{lag_days}_{year}.csv"
...
print(f"\n📊 MLR for Illness: {illness_name} | Lag: {lag_days} | Year: {year}")
