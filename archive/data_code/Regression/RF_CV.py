...
output_base_dir = "/Users/jay/Desktop/Illness Prediction/Processed Data/Regression Results/RF with CV/BE_lag3"
k_folds = 5
...
for filename in os.listdir(merged_data_dir):
    ...
    output_path = os.path.join(output_dir, f"RF_cv_{lag_label}.csv")
    pd.DataFrame(results).to_csv(output_path, index=False)
    print(f"✅ RF with CV done for {illness_name} — saved to {output_path}")
