...
output_filename = f"RF_FS_{illness_name}_lag{lag_number}_train_test.csv"
...
# === MANUAL FORWARD SELECTION + GRID SEARCH FOR RF ===
param_grid = {
...
while remaining_vars:
    ...
    for candidate in remaining_vars:
        ...
        for params in product(*param_grid.values()):
            ...
            model = RandomForestRegressor(**param_combo, random_state=42, n_jobs=-1)
